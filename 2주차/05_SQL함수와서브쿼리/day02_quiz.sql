...
/* -------------------------------------------------------------------
   ...
   ------------------------------------------------------------------- */
SELECT i.InvoiceId, i.Total, i.BillingCountry, c.LastName, c.FirstName
FROM invoices i
JOIN customers c
...
/* -------------------------------------------------------------------
   ...
   ------------------------------------------------------------------- */
SELECT c.FirstName || ' ' || c.LastName AS customer_name, c.Email AS customer_email
FROM customers c
WHERE CustomerId IN (
   SELECT CustomerId
   FROM invoices
...
/* -------------------------------------------------------------------
   ...
   ------------------------------------------------------------------- */
SELECT BillingCountry, 매출합계
FROM (
   SELECT i.BillingCountry, SUM(Total) AS 매출합계
   FROM invoices i
