...
CREATE TABLE department (
    ...
    dept_name   VARCHAR(50) NOT NULL, -- NULL값 미허용
...
-- 커밋 : 수정, 삭제, 갱신 등 작업이 완료되면 DB에 최종반영
-- COMMIT;
COMMIT;
...
-- 하나씩 입력할 때는 Default 필드(컬럼)은 생략가능
...
INSERT INTO course (course_id, title, credit, prof_id)
VALUES ('CS999', '정상강의', 5, 'P001');

-- ============================================================
-- 예제 07: CHECK 제약 - 교수 임용 연도 1980년 이상만 가능
INSERT INTO professor (prof_id, name, email, dept_id, hire_year)
VALUES ('P001', '허정모', 'jm@yeardream.ac.kr', 'CSE', 1980);
...
-- SQLite는 PRIMARY KEY 생성시, NOT NULL을 같이 포함하자 (Oracle은 자동포함)
